...
import { Registry } from '@digitalcredentials/issuer-registry-client';

type IssuerAuthEntry = AuthConfiguration;

function platformSelect<T>(options: { ios: T, android: T }): T {
...
export const issuerAuthRegistry = new Registry<IssuerAuthEntry>({
