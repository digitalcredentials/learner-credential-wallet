...
//  eduWalletShare
//
//  Created by Dmitri Zagidulin on 1/7/22.
//
import UIKit
import Social
...
class ShareViewController: SLComposeServiceViewController {
 ...
 let shareProtocol = "edu.mit.eduwallet" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
